...
<head>
    ...
    <title>eduPGT | Izin Tidak Masuk</title>
...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <div class="modal fade" id="editUserModal" tabindex="-1" aria-labelledby="editUserModalLabel" aria-hidden="true">
            <form action="/izin2/edit" method="post" id="edit-user-form" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tanggal_izin" class="form-control" placeholder="Jam keluar" id="tanggal_izin" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="bukti" class="form-control" placeholder="Bukti" id="bukti" required>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody id="majorTableBody">
                                            ...
                                            ?>
                                                ...
                                                <td>
                                                <?= date("d F Y", strtotime($hasilDataIzin['tanggal_izin'])); ?>
                                                </td>
                                                <td>
                                        ...
                                        ;">
                                               ...
                                               <td style="white-space: nowrap;">
                                                    ...
                                                    <button class="btn btn-sm btn-warning" data-toggle="modal" data-target="#editUserModal" onclick="kirimdata(<?= $hasilDataIzin['id'] ?>, '<?= $hasilDataIzin['nama'] ?>','<?= $hasilDataIzin['nim'] ?>','<?= $hasilDataIzin['kelas'] ?>','<?= $hasilDataIzin['jurusan'] ?>',
                                                        '<?= $hasilDataIzin['keperluan'] ?>','<?= $hasilDataIzin['tanggal_izin'] ?>')">Ubah</button>
                                                    <form action="/izin2/delete/<?= $hasilDataIzin["id"] ?>" method="post" class="form-delete d-inline-block">
    ...
    <script>
        function kirimdata(id, nama, nim, kelas, jurusan, keperluan, tanggal_izin) {

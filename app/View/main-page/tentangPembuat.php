  ...
  <div class="container">
    <div class="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
      <div class="col-12 col-lg-6 col-xl-5">
        <img class="img-fluid rounded" loading="lazy" src="<?php __DIR__ ?>/img/owner.jpeg" alt="">
      </div>
      <div class="col-12 col-lg-6 col-xl-7">
        <div class="row justify-content-xl-center">
          <div class="col-12 col-xl-11">
            <h2 class="h1 mb-3">Who Are We?</h2>
            <p class="lead fs-4 text-secondary mb-3">Kami Mahasiswa Politeknik Gajah Tunggal Prodi Elektronika, berkarya di dunia digital untuk menyongsong pendidikan yang lebih aktif dan kekinian.</p>
            <p class="mb-5">Kami harap dengan adanya aplikasi ini dapat membantu mahasiswa Politeknik Gajah Tunggal dalam melakukan sistem informasi dua arah baik antara manajemen dengan Mahasiswa itu sendiri.</p>
            <div class="row gy-4 gy-md-0 gx-xxl-5X">
              <div class="col-12 col-md-6">
                <div class="d-flex">
                  ...
                  <div>
                    <h4 class="mb-3"> Content Manager</h4>
                    <p class="text-secondary mb-0">Finnan Erlandung - Peranan sebagai content manager dalam pengelolaan UI/UX lebih baik.</p>
                  </div>
                </div>
              </div>
              <div class="col-12 col-md-6">
                <div class="d-flex">
                  ...
                  <div>
                    <h4 class="mb-3"> Devops Engineer</h4>
                    <p class="text-secondary mb-0">Rizky Agusti - Peranan sebagai DevOps Engineer dalam membangun aplikasi yang interaktif.</p>
                  </div>
                </div>
              </div>
            </div>

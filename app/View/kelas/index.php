...
<body class="hold-transition sidebar-mini">
                                    ...
                                    <?php
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    if ($firstRow) {
                                                    ?>
                                                        <td rowspan="<?= count($kelas) ?>"><?= $no++ ?></td>
                                                        <td rowspan="<?= count($kelas) ?>"><?= $major['nama'] ?></td>
                                                    <?php
                                                        $firstRow = false;
                                                    }
                                                    ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // Fungsi untuk mendapatkan nama kelas berdasarkan ID kelas (sesuaikan dengan logika Anda)
            function getNamaKelasById(idKelas) {
                // Implementasikan logika untuk mendapatkan nama kelas berdasarkan ID kelas
                // ...
            }
